    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="page-inner mt--5">
                <div class="form-container" style="background: #fff; border-radius: 6px; box-shadow: 0 1px 4px rgba(0,0,0,0.1); padding: 40px;">
                    <form>
                        <div class="form-group" style="margin-bottom: 15px;">
                            <label style="font-weight: 500;">NIM</label>
                            <input type="text" class="form-control" value="3312xxxx" readonly
                                style="background:#e9ecef;border:none;border-radius:6px;height:35px;width:70%;">
                        </div>

                        <div class="form-group" style="margin-bottom: 15px;">
                            <label style="font-weight: 500;">Name</label>
                            <input type="text" class="form-control" value="StudentA" readonly
                                style="background:#e9ecef;border:none;border-radius:6px;height:35px;width:70%;">
                        </div>

                        <div class="form-group" style="margin-bottom: 15px;">
                            <label style="font-weight: 500;">Study Program</label>
                            <input type="text" class="form-control" value="D3 - Informatics Engineering" readonly
                                style="background:#e9ecef;border:none;border-radius:6px;height:35px;width:70%;">
                        </div>

                        <div class="form-group" style="margin-bottom: 15px;">
                            <label style="font-weight: 500;">Departement</label>
                            <input type="text" class="form-control" value="Informatics Engineering" readonly
                                style="background:#e9ecef;border:none;border-radius:6px;height:35px;width:70%;">
                        </div>

                        <div class="form-group" style="margin-bottom: 15px;">
                            <label style="font-weight: 500;">Class</label><br>
                            <label style="margin-right: 20px;">
                                <input type="radio" name="class" checked> Regular class
                            </label>
                            <label>
                                <input type="radio" name="class"> Evening class
                            </label>
                        </div>

                        <div class="form-group" style="margin-bottom: 15px; display: flex; align-items: center; gap: 10px;">
                            <label style="font-weight: 500; margin: 0;">Semester</label>
                            <select class="form-select"
                                style="background:#e9ecef;border:none;border-radius:6px;height:35px;width:80px;
               text-align-last:center;text-align:center;">
                        ...
                        <div class="form-group" style="margin-bottom: 15px;">
                            ...
                            <input type="text" class="form-control" value="Lecturer A" readonly
                                style="background:#e9ecef;border:none;border-radius:6px;height:35px;width:70%;">
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 15px;">
                            ...
                            <div style="margin-top: 8px; display: flex; flex-direction: column; gap: 24px; width:70%;">
                                <input type="text" placeholder="Input new Company"
                                    style="background:#e9ecef;border:none;border-radius:6px;height:35px;padding-left:10px;">
                                <input type="text" placeholder="Contact Company"
                                    style="background:#e9ecef;border:none;border-radius:6px;height:35px;padding-left:10px;">
                            </div>
                        </div>

                        <div class="form-group" style="margin-bottom: 15px;">
                            <label style="font-weight: 500;">Company Address</label>
                        ...
                        <div class="form-group" style="margin-bottom: 25px;">
                            <label style="font-weight: 500;">Active WhatsApp Number</label>
                            <input type="text" class="form-control"
                                style="background:#e9ecef;border:none;border-radius:6px;height:35px;width:70%;">
                        </div>

                        <div class="text-center">
                            <button type="button" style="background:#ff0000;color:#fff;border:none;border-radius:6px;width:120px;height:40px;margin-right:20px;margin-left:100px;font-weight:500;">Cancel</button>
                            <button type="submit" style="background:#5A9BF6;color:#fff;border:none;border-radius:6px;width:120px;height:40px;font-weight:500;margin-left: 80px;">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
