    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
                    ...
                    <div class="col-md-12">
                        <div class="form-container">
                            <form id="internshipForm">
                                ...
                                <div class="form-group">
                                    <label>Did you receive the internship response within 14 days?</label>
            ...
            <script>
                ...
                // Form Logic - Show/Hide Upload Section
                ...
                function checkAnswers() {
                    const received = responseReceived.value;

                    // Tampilkan upload section jika jawaban pertama adalah "yes"
                    // Tidak peduli jawaban kedua apa
                    if (received === 'yes') {
                ...
                responseReceived.addEventListener('change', checkAnswers);
                responseWithin14Days.addEventListener('change', checkAnswers);
                ...
                document.getElementById('internshipForm').addEventListener('submit', function(e) {
                    ...
                    const received = responseReceived.value;
                    const within14Days = responseWithin14Days.value;

                    if (!received || !within14Days) {
                        alert('Please answer all questions');
                        return;
                    }

                    if (received === 'yes' && within14Days === 'yes') {
                        const fileInput = document.getElementById('fileInput');
                        if (!fileInput.files.length) {
                            alert('Please upload your internship response letter');
                            return;
                        }
                    }
