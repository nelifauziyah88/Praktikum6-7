...
<body>
    ...
    <div class="container-permohonan" id="content-permohonan">
        ...
        <div class="recipient">
            ...
            <strong>PT petrolog harapan abadi semesta</strong><br>
            <strong>di bertingat set 22C</strong>
        </div>

        <div class="content-permohonan">
            <p>Dengan hormat kami sampaikan apresiasi yang sebesar-besarnya kepada <em>PT petrolog harapan abadi semesta</em>
            ...
            <table class="student-table">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>Adam Maulana<br>Karni Aqilah Arfini</td>
                        <td>4122213136</td>
                        <td>D4 Teknik Informatika<br>Tanggl</td>
                        <td>18 Agustus 2025 - 18 April 2026</td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="signature-section">
            ...
            <div class="signature-box">
                ...
                <div class="signature-image">
                    <img src="assets/img/wadir.png" alt="Stempel">
                </div>
        ...
        <table class="student-table-balasan">
            ...
            <tbody id="studentTable">
                <tr>
                    ...
                    <td><input type="text"></td>
                    <td><input type="text"></td>
                    <td class="checkbox-cell"><div class="checkbox-container" onclick="toggleCheckbox(this)"></div></td>
                    <td class="checkbox-cell"><div class="checkbox-container" onclick="toggleCheckbox(this)"></div></td>
                    <td><input type="text"></td>
                </tr>
                <tr>
    ...
    <script>
        function toggleCheckbox(element) {
            ...
            const checkboxes = row.querySelectorAll('.checkbox-container');
            checkboxes.forEach(cb => cb.classList.remove('checked'));
            element.classList.add('checked');
        }

        async function downloadPDF() {
            const permohonan = document.getElementById("content-permohonan");
            const balasan = document.getElementById("content-balasan");
            ...
            // Capture halaman 1 (Surat Permohonan)
            const canvas1 = await html2canvas(permohonan, {
                scale: 2,
                useCORS: true,
            ...
            const scaleFactor1 = imgHeight1 > pageHeight ? pageHeight / imgHeight1 : 1;
            const finalWidth1 = imgWidth1 * scaleFactor1;
            const finalHeight1 = imgHeight1 * scaleFactor1;

            pdf.addImage(imgData1, "JPEG", 0, 0, finalWidth1, finalHeight1);

            // Tambah halaman baru untuk Surat Balasan
            pdf.addPage();

            // Capture halaman 2 (Surat Balasan)
            const canvas2 = await html2canvas(balasan, {
                scale: 2,
                useCORS: true,
                letterRendering: true,
                scrollY: 0
            ...
            const scaleFactor2 = imgHeight2 > pageHeight ? pageHeight / imgHeight2 : 1;
            const finalWidth2 = imgWidth2 * scaleFactor2;
            const finalHeight2 = imgHeight2 * scaleFactor2;

            pdf.addImage(imgData2, "JPEG", 0, 0, finalWidth2, finalHeight2);

            // Download PDF
            pdf.save("Surat_Magang_Industri.pdf");
        }
