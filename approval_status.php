                ...
                <div style="background: #fff; border-radius: 8px; box-shadow: 0 1px 4px rgba(0,0,0,0.1); overflow: hidden;">
                    ...
                    <div style="padding: 25px;">
                        <table style="width: 100%; border-collapse: collapse; text-align: center;">
                            <thead>
                                <tr style="background: #f3f6f9; border-bottom: 2px solid #ddd;">
                                    <th style="padding: 10px; width: 5%;">No</th>
                                    <th style="padding: 10px; width: 15%; cursor: pointer; position: relative;">
                                        Date
                                        <!-- Dua panah samping-sampingan -->
                                        <span style="display: inline-flex; align-items: center; gap: 3px; margin-left: 5px; vertical-align: middle;">
                                            <i class="fa-solid fa-arrow-up" style="font-size: 10px; color: #555;"></i>
                                            <i class="fa-solid fa-arrow-down" style="font-size: 10px; color: #555;"></i>
                                        </span>
                                    </th>
                                    <th style="padding: 10px; width: 20%;">Approval by Internship Coordinator</th>
                                    <th style="padding: 10px; width: 20%;">Approval by CDC Administrator</th>
                                    <th style="padding: 10px; width: 15%;">Status</th>
                                    <th style="padding: 10px; width: 15%;">Download Letter</th>
                            ...
                            <tbody>
                                <tr style="border-bottom: 1px solid #ddd;">
                                    ...
                                    <td style="padding: 10px;">29/9/25</td>
                                    <td style="padding: 10px;">
                                        <button style="background: #1CC88A; color: white; border: none; border-radius: 4px; padding: 6px 12px;">Approve</button>
                                    </td>
                                    <td style="padding: 10px;">
                                        <button style="background: #1CC88A; color: white; border: none; border-radius: 4px; padding: 6px 12px;">Approve</button>
                                    </td>
                                    <td style="padding: 10px;">
                                        <button style="background: #1CC88A; color: black; border: none; border-radius: 4px; padding: 6px 12px;">Accepted</button>
                                    </td>
                                    <td style="padding: 10px; display: flex; justify-content: center;">
                                        <button style="background: #E9ECEF; border: none; border-radius: 4px; padding: 6px 12px; display: flex; align-items: center; justify-content: center; gap: 5px; cursor: pointer;">
                                            <i class="fa fa-download"></i> Download
                                        </button>
                                    </td>
                                    <td style="padding: 10px;">
                                        <div style="position: relative; display: inline-block;">
                                            <button id="actionBtn" style="background: #5A9BF6; color: #fff; border: none; border-radius: 4px; padding: 6px 12px; cursor: pointer;">
                                                Action ▼
                                            </button>
                                            <div id="actionMenu" style="display: none; position: absolute; top: 35px; right: 0; background: #fff; border: 1px solid #ccc; border-radius: 4px; box-shadow: 0 2px 6px rgba(0,0,0,0.1); z-index: 10; min-width: 180px;">
                                                <a href="accepted_by_company.php" style="display: block; padding: 8px 12px; color: #333; text-decoration: none; white-space: nowrap;">
                                                    Accepted by Company
                                                </a>
                                                <a href="rejected_by_company.php" style="display: block; padding: 8px 12px; color: #333; text-decoration: none; white-space: nowrap;">
                                                    Rejected by Company
                                                </a>
                                            </div>
                                        </div>
